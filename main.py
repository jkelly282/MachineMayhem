...
class Food:
    ...
    def draw_food(self):
        pygame.draw.circle(self.surface, (255,0,0), (self.x , self.y)  , int(self.food), int(self.food))
...
class Snake:
    ...
    def draw_head(self):
        ...
        for i in range(self.segments):
            ...
            x = self.shapeX
            y= self.shapeY
            pygame.draw.rect(self.UI, (0,255,0), (x  , y   , self.shape_size, self.shape_size))
    ...
    def draw_body(self)-> None:
        for i in self.body:
            pygame.draw.rect(self.UI, (0,255,0), (i[0], i[1],  self.shape_size, self.shape_size))
